...
export enum Direction {Left = -1, Right = 1, Up = -1, Down = 1}


export const compareValues = (valA: number, valB: number) :number => {
  if (valA > valB){
    return 1;
  }else if (valA < valB){
    return -1;
...
export const updateElementValue = (elementId:any, newVal:any, callBack:any = null) => {
...
export const getRandomBoxPos = (box:any, padding:number = 6) :number[] => {
...
export const getDistance = (objectA:any, objectB:any) => {
...
interface objectPositionCheck {
  (objectA:any, objectB:any):boolean
}

export const isAInXOfB: objectPositionCheck = (objectA, objectB) =>{
...
export const isAInYOfB: objectPositionCheck = (objectA, objectB) =>{
...
export const isAAboveB: objectPositionCheck = (objectA, objectB) =>{
  return objectA.PosY() < objectB.PosY() 
      && objectA.PosY() + objectA.GetHeight() < objectB.PosY() + objectB.GetHeight();   
}
export const isTopCollision: objectPositionCheck = (objectA, objectB) =>{
    return objectA.PosY() + objectA.GetHeight() + objectA.DirY() > objectB.PosY();  
} 
export const isBottomCollision: objectPositionCheck = (objectA, objectB) =>{
...
export const isALeftOfB: objectPositionCheck = (objectA, objectB) =>{
  return objectA.PosX() < objectB.PosX() 
      && objectA.PosX() + objectA.GetWidth() < objectB.PosX() + objectB.GetWidth(); 
}
export const isRightCollision: objectPositionCheck = (objectA, objectB) =>{
    return objectA.PosX() + objectA.GetWidth() + objectA.DirX() > objectB.PosX();  
}       
export const isLeftCollision: objectPositionCheck = (objectA, objectB) =>{
    return objectA.PosX() - objectA.GetWidth() < objectB.PosX() + objectB.GetWidth();  
}       

export const isCollidingOnX: objectPositionCheck = (objectA, objectB) => {
...
export const isCollidingOnY: objectPositionCheck = (objectA, objectB) => {
  if (objectA.HasTag("entity")) {
    // debugger
  }
...
export const hasOverlapTop: objectPositionCheck = (objectA, objectB) => {
  if (!isAInXOfB(objectA, objectB)) return false;

  return (objectA.PosY() <= objectB.PosY() + objectB.GetHeight()
    && objectA.PosY() + objectA.GetHeight() > objectB.PosY());
}
export const hasOverlapBottom: objectPositionCheck = (objectA, objectB) => {
  if (!isAInXOfB(objectA, objectB)) return false;

  return (objectA.PosY() + objectA.GetHeight() >= objectB.PosY() 
    && objectA.PosY() < objectB.PosY() + objectB.GetHeight());
}
export const hasOverlapRight: objectPositionCheck = (objectA, objectB) => {
  if (!isAInYOfB(objectA, objectB)) return false;

  return (objectA.PosX() + objectA.GetWidth() >= objectB.PosX() 
    && objectA.PosX() < objectB.PosX() + objectB.GetWidth());
}
export const hasOverlapLeft: objectPositionCheck = (objectA, objectB) => {
  if (!isAInYOfB(objectA, objectB)) return false;
...
export const hasCollision: objectPositionCheck = (objA, objB) => {
  // debugger
...
export const getCenterLineX = (obj:any) => {
  const pA = {
    x: obj.PosX(),
...
export const getCenterLineY = (obj:any) => {
  const pA = {
...
export const getLineSide = (point:any, line:any) => {
  const pA = line.pA;
  const pB = line.pB;
...
export const getObjectASideBOnX = (objectA:any, objectB:any) => {
  const sideX = getLineSide(objectA.pos, getCenterLineY(objectB));
  // debugger
  return sideX;
}

export const getObjectASideBOnY = (objectA:any, objectB:any) => {
  const sideY = getLineSide(objectA.pos, getCenterLineX(objectB));
  // debugger
  return sideY;
}

export const addElement = (atElId:any, elType:any, content:any, insertBefore:boolean = true):void => {
